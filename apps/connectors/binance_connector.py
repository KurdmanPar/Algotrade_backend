...
class BinanceConnector(IExchangeConnector):
    """
    کانکتور واقعی برای صرافی Binance.
    """
    def __init__(self, api_key: str, api_secret: str, config: MarketDataConfig, agent):
    ...
    async def subscribe_to_instrument(self, symbol: str, timeframe: str):
    ...
    def get_historical_data(self, symbol: str, timeframe: str, start: str, end: str):
        # پیاده‌سازی برای گرفتن داده تاریخی از Binance REST API
        pass

    def cancel_subscription(self, symbol: str, timeframe: str):
